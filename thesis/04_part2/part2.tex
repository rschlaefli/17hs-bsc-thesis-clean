...
We generally assume that the reader is at least familiar with basic neural network principles for the remainder of this work. However, as convolutional and recurrent layers are basic building blocks of ConvLSTM2D layers, we first shortly summarize their respective characteristics. We then go into the work of \citet{Shi.2015} and their approach to creating the convolutional recurrent ConvLSTM2D layer and describe the areas where their an approach has already been tried.
