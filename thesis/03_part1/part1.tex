...
We mainly attribute the pattern of high degree and PageRank to the retreat of the ISM as well as the following buildup-phase of the north-east monsoon. Some locations experience more rainfall than even during monsoon, because the reversal of the temperature gradient leads to [TODO: finish]
...
As we have based our analyses on the work of \citet{Stolbova.2015}, we have similarly calculated the degree and betweenness for climate networks thresholded at the 95th percentile. However, there are certain important differences and additions in our implementation that need to be taken into account when comparing the results in the next section. More specifically:
