...
\begin{figure}[H]
  ...
  \caption{Weighted and unweighted degree, betweenness centrality and PageRank for the pre-monsoon season (MAM). Based on the TRMM dataset at {0.75\degree} resolution.}
  \label{fig:results_mam}
\end{figure}

The results of applying our algorithms to the pre-monsoon season, namely the months of March, April and May (MAM), are shown in \cref{fig:results_mam}. We show the unweighted version, as also computed in \citet{Stolbova.2015}, as well as the version with weights applied to the edges in the network. To enable intercomparison with the work of \citet{Stolbova.2015}, which this part of our work is based on, we additionally assign the same identifier as she has used in her work to any areas we refer to.
...
\begin{figure}[H]
  ...
  \caption{Weighted and unweighted degree, betweenness centrality and PageRank for the primary monsoon season (JJAS). Based on the TRMM dataset at {0.75\degree} resolution.}
  \label{fig:results_jjas}
\end{figure}

Analyzing the months of the primary monsoon season (JJAS: June, July, August, September) as shown in \cref{fig:results_jjas} yields somewhat unexpected results: degree and betweenness both display a strong but relatively contained pattern over Northern Pakistan (NP). Further areas of significant degree are located on the Tibetan Plateau (TB) and over the Indian Ocean around the southern tip of India (Arabian Sea/WG, BoB).
...
The last season of the ISM, the post-monsoon season or north-east monsoon, displays

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{{./99_appendix/img/event_sync_0.75-0.9_OND}.png}
  \caption{Weighted and unweighted degree, betweenness centrality and PageRank for the post-monsoon season (OND). Based on the TRMM dataset at {0.75\degree} resolution.}
