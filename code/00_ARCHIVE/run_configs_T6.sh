...
PATIENCE=0
VERSION=T6-$EPOCHS
LOG_DIR=~/thesis/code/00_LOGS/$VERSION
# EVALUATE=false
...
# train model
~/anaconda3/envs/gru-minimal/bin/python ~/thesis/code/02_MODELLING/LSTM_T6.py $SLURM_ARRAY_TASK_ID $EPOCHS $PATIENCE $VERSION >> $LOG_DIR/$SLURM_ARRAY_TASK_ID/$SLURM_JOB_ID.out
