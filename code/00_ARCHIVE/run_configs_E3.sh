...
# train model
~/anaconda3/envs/gru-minimal/bin/python ~/thesis/code/02_MODELLING/LSTM_E3.py $SLURM_ARRAY_TASK_ID $EPOCHS $PATIENCE $VERSION >> $LOG_DIR/$SLURM_ARRAY_TASK_ID/$SLURM_JOB_ID.out
