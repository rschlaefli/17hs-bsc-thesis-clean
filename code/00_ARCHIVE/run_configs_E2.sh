...
EPOCHS=50
PATIENCE=0
LOG_DIR=~/thesis/code/00_LOGS/E2
# EVALUATE=false
...
# train model
~/anaconda3/envs/gru-minimal/bin/python ~/thesis/code/02_MODELLING/LSTM_E2.py $SLURM_ARRAY_TASK_ID $EPOCHS $PATIENCE >> $LOG_DIR/$SLURM_ARRAY_TASK_ID/$SLURM_JOB_ID.out
