...
from keras.layers import BatchNormalization, Dropout, LSTM, Dense, ConvLSTM2D, Flatten, MaxPooling2D, MaxPooling3D, TimeDistributed, Conv2D, LSTM, Input
...
class ModelBASEv2B:
    ...
    def build(self,
        ...
        main_output = Dense(1, name='main_output', activation='sigmoid')(x)
